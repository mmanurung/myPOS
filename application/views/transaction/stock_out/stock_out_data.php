<section class="content-header">
    <h1>Stock Out
        <small>Barang Keluar/ Tidak dipakai</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <?php $no = 1;
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            ...
                            <a href="<?=site_url('stock/out/del/'.$data->stock_id.'/'.$data->item_id)?>" onclick="return confirm('Apakah yakin?')" class="btn btn-danger btn-xs">
